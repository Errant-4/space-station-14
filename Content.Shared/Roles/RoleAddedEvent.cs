...
public sealed record RoleAddedEvent(EntityUid MindId, MindComponent Mind, EntityUid MindRoleId, bool RoleTypeUpdate, bool Silent = false) : RoleEvent(MindId, Mind, RoleTypeUpdate);
